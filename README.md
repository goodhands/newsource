...
Get all recent articles: `http://localhost:8000/api/articles`
Get a single article with the author details: `http://localhost:8000/api/articles/1?include=authors`
Search for a headline or content you're interested in: `http://localhost:8000/api/articles?search=Arsenal`
Fetch all categories: http://localhost:8000/api/categories
Filter articles by a category: http://localhost:8000/api/articles?filter[category]=Technology
Fetch all authors: http://localhost:8000/api/authors
Filter articles by author: http://localhost:8000/api/articles?filter[author]=Samuel Olaegbe
Fetch all tags: http://localhost:8000/api/tags
Fetch articles by tag: http://localhost:8000/api/articles?filter[tag]=Tag
Set your preferences: http://localhost:8000/api/user_preferences
